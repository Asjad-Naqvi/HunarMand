  ...
  const HOW_IT_WORKS = [
    {
      ...
      body: "Chat with Haazir in plain language — Urdu, English, or whatever is comfortable. Say what you need, where, and when.",
    },
    {
      step: "2",
      icon: "sparkles-outline" as const,
      title: "AI Understands & Matches",
      body: "Haazir's AI agent parses your request, extracts the service type, location, time, and complexity, then matches you with the best verified provider nearby.",
    },
    {
      step: "3",
      icon: "person-circle-outline" as const,
      title: "Provider Accepts",
      body: "The matched provider receives a job card and accepts or declines. If they decline, Haazir automatically finds you the next best match — no waiting.",
    },
    {
      step: "4",
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.title} pointerEvents="none">About Haazir</Text>
        <View style={{ width: 48 }} />
      </View>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroTitle}>Haazir</Text>
          <Text style={styles.heroTagline}>Pakistan's first AI-powered home services platform</Text>
        </View>

        {/* What is Haazir */}
        <View style={[styles.card, Shadows.card]}>
          <Text style={styles.cardTitle}>What is Haazir?</Text>
          <Text style={styles.cardBody}>
            Haazir (حاضر) means "present" — and that is exactly what we do. We connect you instantly with trusted,
            verified home service providers across Islamabad using a conversational AI agent.{"\n\n"}
            No forms, no browsing, no haggling. Just describe your problem in plain language and Haazir handles the rest.
          </Text>
        </View>
        ...
        <View style={[styles.agentCard, Shadows.card]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.agentBody}>
              Haazir uses multiple specialised AI agents — one for booking, one for disputes, and one for provider dispatch.
              Each agent runs on Google Gemini and makes decisions that are fair, fast, and transparent.
            </Text>
          </View>
        </View>

        <Text style={styles.version}>Haazir v1.0.0 — Hackathon Build</Text>
      </ScrollView>
    </SafeAreaView>
  );
};
