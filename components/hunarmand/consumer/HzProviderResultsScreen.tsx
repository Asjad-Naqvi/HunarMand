  ...
  return (
    <View style={[styles.card, Shadows.card]}>
      ...
      <View style={{ marginTop: 4, alignSelf: "flex-start" }}>
        <Pill label="✓ HunarMand Verified" bg={Colors.success} color={Colors.white} />
      </View>
...
export const HzProviderResultsScreen: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"hunarmand" | "maps">("hunarmand");
  ...
  const currentResultsCount =
    activeTab === "hunarmand" ? registeredProviders.length : displayedMapsProviders.length;
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      <View style={styles.tabRow}>
        <TouchableOpacity
          onPress={() => setActiveTab("hunarmand")}
          style={[styles.tab, activeTab === "hunarmand" && styles.tabActive]}
        >
          <Text style={[styles.tabText, activeTab === "hunarmand" && styles.tabTextActive]}>
            HunarMand Providers ({registeredProviders.length})
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
      ...
      >
        <Text style={styles.resultCount}>
          Showing {currentResultsCount} {activeTab === "hunarmand" ? "registered" : "Google Directory"} providers
        </Text>
          ...
          {activeTab === "hunarmand" ? (
            registeredProviders.length > 0 ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>No registered HunarMand providers found in this area.</Text>
              </View>
            )
          ) : (
