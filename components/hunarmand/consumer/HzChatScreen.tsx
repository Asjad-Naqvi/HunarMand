  ...
  return (
    <Animated.View style={[styles.thinkingBlock, animatedStyle]}>
      ...
      >
        ...
        <Text style={styles.thinkingTitle}>HunarMand's Reasoning — Intent Extraction</Text>
...
export const HzChatScreen: React.FC = () => {
  ...
  const WELCOME_MSG: ChatMessage = {
    id: "welcome",
    sender: "agent",
    text: "Assalam o Alaikum! Main Hunar hoon. Aapko kaunsi service chahiye? Bas batayein — Urdu mein, English mein, ya jis tarah chaahein.",
    time: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }),
  };

  const handleClearChat = async () => {
    try {
      const storageKey = `hunarmand_chat_history_customer_${user?.id || "anonymous"}`;
        ...
        >
          ...
          {loading && (
            <View style={styles.loadingWrapper}>
              ...
              <Text style={styles.loadingText}>HunarMand is thinking...</Text>
            </View>
          )}
        </ScrollView>
